...
// TODO: implement the fix for parameters inside of parameters. It can't be a flat vector with a
// comma separating each value. This causes errors. Instead create a struct for each command with a
