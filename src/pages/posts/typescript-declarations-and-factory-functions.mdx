...
export const meta = BLOG_POSTS_META.TYPESCRIPT_DECLARATIONS_AND_FACTORY_FUNCTIONS
...
export default ({children})=> (
  <Layout title={meta.title} description={meta.description} date={meta.publishDate}>
    <BlogLayout title={meta.title}>
      {children}
    </BlogLayout>
  </Layout>
)