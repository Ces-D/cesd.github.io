  ...
  const filteredPosts = useMemo(() => {
    return props.posts.filter(
      (card) =>
        ...
        card.tags.includes(searchValue.toLowerCase())
    );
  }, [searchValue]);
  ...
  return (
    <Container title="Blog - Cesar Diaz">
      <div className="flex flex-col gap-y-2 justify-center">
        ...
        <p>Use the search below to filter by tags and titles</p>
        <div className="relative w-full mb-4">
          <input
            ...
            type="text"
            className="border=box p-2 border-darkGray focus:ring-teal focus:border-teal w-full rounded-md bg-transparent text-darkGray"
          />
          <svg
