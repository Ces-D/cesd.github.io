...
<main class="grid grid-cols-1 min-h-screen bg-background grid-rows-[auto_1fr] font-lato">
  <nav
    class="flex sticky top-0 z-10 grid-cols-2 items-center p-1 w-full shadow-sm md:p-2 2xl:p-4 bg-background"
  >
    <h3 class="flex-1">
